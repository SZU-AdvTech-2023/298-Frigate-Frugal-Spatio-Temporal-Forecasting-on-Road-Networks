...
class GNN(nn.Module):
    def __init__(this, input_dim, hidden_dim, output_dim, nlayers):  #, learning_rate, l2_regularization
        super().__init__()
        ...
        # this.optimizer = optim.Adam(this.parameters(), lr=learning_rate, weight_decay=l2_regularization)
...
class Encoder(nn.Module):
    def __init__(this, input_dim, hidden_dim, enc_input_dim, enc_hidden_dim, nlayers):
        super().__init__()
        # 设置学习率和 L2 正则化
        this.gnn = GNN(input_dim, hidden_dim, enc_input_dim//2, nlayers)   #, learning_rate= 0.001, l2_regularization = 0.0001
